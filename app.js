...
/// Data was filtered to only display Poverty and Physical acivity from the origional dataset 
d3.csv("../../data/data.csv", function(err, healthData) {
    ...
    chart.selectAll("circle")
        ...
        .attr("r", "15")
        .attr("fill", "lightblue")
        // display tooltip on mouseover of data
        .on("mouseenter", function(data) {
            toolTip.show(data);
        })
        // hide tooltip on mouseout of data
